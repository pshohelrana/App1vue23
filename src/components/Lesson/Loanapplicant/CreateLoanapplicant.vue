...
const nominee_name = ref(0);
const nominee_account = ref(0);
...
const brand_r = Http.get(`${Settings.baseURL}/members`);
...
const onSubmit = () => {
    ...
    formData.append("nominee_name", nominee_name.value);
    formData.append("nominee_account", nominee_account.value);
    ...
    const result_save = Http.post(`${Settings.baseURL}/loanapplicants`, formData);
...
<template>
    ...
    <h3>Create Loanapplicant</h3>
    <div class="container">

        <div class="card">
            <div class="card-header">Create Loanapplicant</div>
            <div class="card-body">
                ...
                <form @submit.prevent="onSubmit">
                    ...
                    <div class="row mb-2">
                        <label class="col-3 form-label">Occupation</label>
                        <div class="col-9">
                            <input v-model="occupation" type="text" class="form-control" name="occupation" />
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label class="col-3 form-label">Nominee name</label>
                        <div class="col-9">
                            <input v-model="nominee_name" type="text" class="form-control" name="nominee_name" />
                        </div>
                    </div>
                    <div class="row mb-2">
                        <label class="col-3 form-label">Nominee Account</label>
                        <div class="col-9">
                            <input v-model="nominee_account" type="text" class="form-control" name="nominee_account" />
                        </div>
                    </div>
                    <div class="row mb-2">
